      ...
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        ...
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-[#E7E6EB] dark:border-[#5C5C5C] sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-lg text-[#9B9B9F] border border-[#E7E6EB] dark:border-[#5C5C5C] hover:bg-[#F1F3FA] dark:hover:bg-white/5 dark:text-[#EDEDED] transition-colors lg:flex lg:h-11 lg:w-11"
          >
            {isMobileOpen ? (
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 rounded-lg text-[#12033A] hover:bg-[#F1F3FA] dark:text-[#EDEDED] dark:hover:bg-white/5 transition-colors lg:hidden"
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              <path fillRule="evenodd" clipRule="evenodd"
